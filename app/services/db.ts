...
instructor_id_51 TEX,
    instructor_id_52 TEX,
    instructor_id_53 TEX,
    instructor_id_54 TEX,
    instructor_id_55 TEX,
    instructor_id_56 TEX,
    instructor_id_57 TEX,
    instructor_id_58 TEX,
    instructor_id_59 TEX,
    instructor_id_60 TEX,
    instructor_id_61 TEX,
    instructor_id_62 TEX,
    instructor_id_63 TEX,
    instructor_id_64 TEX,
    instructor_id_65 TEX,
    instructor_id_66 TEX,
    instructor_id_67 TEX,
    instructor_id_68 TEX,
    instructor_id_69 TEX,
    instructor_id_70 TEX,
    instructor_id_71 TEX,
    instructor_id_72 TEX,
    instructor_id_73 TEX,
    instructor_id_74 TEX,
    instructor_id_75 TEX,
    instructor_id_76 TEX,
    instructor_id_77 TEX,
    instructor_id_78 TEX,
    instructor_id_79 TEX,
    instructor_id_80 TEX,
  location_id TEXT NOT NULL,
  historical INTEGER DEFAULT 0,
